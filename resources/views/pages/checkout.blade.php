        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details">
              @if ($errors->any())
                <div class="class alert alert-denger">
                  <ul>
              ...
              <div class="member mt-3">
                ...
                <input 
                  ...
                  <button type="submit" class="btn btn-add-now mb-2 px-3">Add Now</button>
                </form>
          ...
          <div class="col-lg-4">
            ...
            <div class="bank">
              <div class="bank-item pb-3">
                ...
                <div class="description">
                  <h3>PT Nomads ID</h3>
                  <p>0881 0000 0231 <br> Bank Middle Asia</p>
                </div>
                <div class="clearfix">
               ...
               <div class="bank-item pb-3">
                ...
                <div class="description">
                  <h3>PT Nomads ID</h3>
                  <p>0881 0000 2221 <br> Bank Middle Afrika</p>
                </div>
                <div class="clearfix">
            ...
            <div class="join-container">
              <a href="{{ route('checkout-success',$item->id) }}" class="btn btn-block btn-join-now mt-3 py-2">I Have Mad Payment</a>
            </div>
...
@push('prepend-style')
    <link rel="stylesheet" href="{{ url('frontend/gjigo/css/gijgo.min.css') }}" />
@endpush

@push('addon-script')
     <script src="{{ url('frontend/js/jquery-3.6.0.min.js') }}"></script>
     <script src="{{ url('frontend/gjigo/js/gijgo.min.js') }}"></script>
     <script>
